    ...
    <section className='flex pt-10 pb-20'>
      ...
      <div className='flex flex-col gap-10 m-auto'>
        <div className='flex flex-col gap-6'>
          <p className='text-[2rem] md:text-[1.8rem] lg:text-[2.4rem] font-bold'>Password Recovery</p>
        ...
        <div className='flex flex-col gap-2'>
          <button className='rounded bg-[#db4444] text-white py-2 px-7 md:px-5 lg:px-8 lg:text-[rem]'>Send Code</button>

        </div>
        <div className='flex justify-center gap-4'>
          <p>Already have account?</p>
          <Link href="/login">
            <p className='text-[#7f7f7f] lg:text-sm' href="#">Log in</p>
          </Link>
        </div>
      </div>
    </section>
